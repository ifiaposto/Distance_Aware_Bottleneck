...
"""
    ...
    This implementation is based on the implementation of Uncertainty Baselines Authors:
        
    https://github.com/google/uncertainty-baselines/blob/main/uncertainty_baselines/datasets/svhn.py
